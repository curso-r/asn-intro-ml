...
- Revisão de regressão linear e logística

- Overfiting

- Bases Treino/Teste

- Reamostragem e Cross-validation

- Regularização (LASSO)

- Tidymodels (Framework do R)
...
Somos consultores e fomos contratados para dar conselhos para uma empresa aumentar as suas vendas. Obtivemos o seguinte banco de dados
...
Somos da área de inadimplência e precisamos agir para assessorar clientes em situação iminente de atraso. Obtivemos o seguinte banco de dados
...
Este material foca em **predição**.
