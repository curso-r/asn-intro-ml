...
<img src="static/img/arvore_rf_gbm.png" style="width: 150%;margin -1000px" />
...
Ver [ISL](https://www.ime.unicamp.br/~dias/Intoduction%20to%20Statistical%20Learning.pdf) página 305.

]

.pull-right[
<img src="static/img/arvore_intuicao.png" style="width: 70%;"/>
...
<img src="static/img/vies_variancia3.png" style="width: 90%;"/>
...
<img src="static/img/vies_variancia.png" style="width: 90%;"/>

Ver [ISL](https://www.ime.unicamp.br/~dias/Intoduction%20to%20Statistical%20Learning.pdf) página 33.
...
.pull-right[
<img src="static/img/vies_variancia2.png" style="width: 90%;"/>
...
- **Random Forest** é a combinação de “palpites” de um monte de árvores de decisão. Algoritmo de uma classe especial de ENSEMBLE: BAGGING.
...
3. Para cada uma das **B** sub-bases $(b, m)$ construa uma árvore de decisão
4. Tire a média das previsões das **B** árvores
